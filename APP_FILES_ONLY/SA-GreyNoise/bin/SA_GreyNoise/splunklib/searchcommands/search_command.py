...
class SearchCommand:
    ...
    class ConfigurationSettings:
        ...
        def __repr__(self):
            ...
            settings = [
                repr((setting.name, setting.__get__(self), setting.supporting_protocols)) for setting in definitions
            ]
        ...
        def iteritems(self):
            ...
            return [
                ...
                for name_value1 in [
                    ...
                    for setting in [setting for setting in definitions if setting.is_supported_by_protocol(version)]
                ]
