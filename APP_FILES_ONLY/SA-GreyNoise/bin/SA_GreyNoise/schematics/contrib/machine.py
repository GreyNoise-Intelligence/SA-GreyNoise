...
class Machine(object):
    ...
    def _transition(self, trigger=None, src_state=None, dst_state=None):
        try:
            return next(self._transitions(trigger=trigger, src_state=src_state, dst_state=dst_state))
    ...
    def _transitions(self, trigger=None, src_state=None, dst_state=None):
        ...
        return (
            ...
            if pred(d, "trigger", trigger) and pred(d, "from", src_state) and pred(d, "to", dst_state)
        )
